...
{    
    ...
    while(1)
    {
        ...
        // Read sensor with ADC
        ADR = adc_read_sensor();
//        ADR = 61;
        
        // Convert to temperature
        voltage = (float)ADR*5.0/1024.0;    // get voltage from adc reading (10-bit)
        temp = voltage / 0.01;       // convert voltage to temperature scale
        temperature = temp;
...
void InitDevice(void)
{
    ...
    // RA0 input for adc for temp sensor
    TRISAbits.TRISA0 = 1;
